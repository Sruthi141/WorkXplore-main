...
import { Download, RefreshCcw, Sparkles, Users2 } from "lucide-react";
      ...
      >
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Manage recruiter accounts and track onboarding status (premium UI).
              </p>
          ...
          <div className="flex flex-wrap gap-2">
            <button
              type="button"
              onClick={() => toast.message("Refresh will reload table data (handled inside Datatable2)")}
