...
const Signup = () => {
  ...
  const validateForm = () => {
    ...
    // ✅ keep as string; validate digits
    if (!input.phoneNumber) {
      errors.phoneNumber = "Phone number is required.";
    } else if (!/^\d{10}$/.test(String(input.phoneNumber))) {
    ...
    if (
      input.file &&
      !["image/jpeg", "image/png", "image/jpg"].includes(input.file.type)
    ) {
      ...
      <div className="flex items-center justify-center max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="my-2">
            ...
            <Input
              type="text" // ✅ CHANGE 3 (better than number)
              inputMode="numeric"
